...
interface ApiService {
     ...
     */
    @GET("/v1/excuse/{category}")
    fun getExcuseForCategoryViaCall(@Path("category") category: String): Call<List<Excuse>>
     ...
     */
    @POST("/dummy/request")
    suspend fun dummyPostRequest(@Body excuse: Excuse) : Response<Excuse>
     ...
     */
    @GET("/dummy/search")
    suspend fun dummySearch(@Query("term") searchTerm: String) : Response<List<Excuse>>
}